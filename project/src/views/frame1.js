  ...
  const handleFileChange = (event) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // Переход на другую страницу после успешной загрузки файла с передачей состояния
        history("/ml", { state: { predictionData: response.data } });
      })
      .catch((error) => {
  ...
  return (
    <div className="frame1-container">
      ...
      <div className="frame1-frame1">
        <img
          src="/fluentmdl2eatdrink6056-2zx.svg"
        ...
        <div className="stars1">
          <img src="/star13.png" className="stars1-star1" />
          <img src="/star13.png" className="stars1-star2" />
          <img src="/star13.png" className="stars1-star3" />
          <img src="/star13.png" className="stars1-star4" />
          <img src="/star13.png" className="stars1-star5" />
        </div>

        <div className="stars2">
          <img src="/star13.png" className="stars2-star1" />
          <img src="/star13.png" className="stars2-star2" />
          <img src="/star13.png" className="stars2-star3" />
          <img src="/star13.png" className="stars2-star4" />
          <img src="/star13.png" className="stars2-star5" />
        </div>
        <img
        ...
        <div className="header">
          ...
          <img src="star17.svg" alt="Star16051" className="frame1-star1" />
          <input
          ...
          <img src="Lupa.png" alt="Ellipse46051" className="frame1-ellipse4" />
